...
public class StudentMapperTests {
    ...
    public void studentInsert() {
        ...
        Student student = Student.builder().studentNumber(studentMapper.studentAutoNumber("01"))
                .studentName("김지수").studentId("springuser").studentPassword("spring1234")
                .studentBirth("20000615").studentPhone("01052058320")
